...
<div class="container mx-2 mb-8 bg-primary10 border py-8 pl-5 rounded-xl border-accent border-r-2 w-20 md:w-auto">
  <div class="flex flex-col items-stretch space-y-60">
    ...
    <!-- Logout -->
    <a href="../account/login.php?fromLogout=1" class="text-accent container border-accent p-4 pl-4 bg-primary30 rounded-l-full md:flex md:items-center md:space-x-2 hover:drop-shadow-lg hover:border hover:scale-105 transform transition-all ">
