    ...
    <main>
        ...
        <div class="flex flex-col items-center mx-auto py-12 px-4 w-auto lg:flex-row-reverse lg:justify-around lg:px-10">
            <form action="./verify.php" method="post" class="container flex flex-col space-y-6 items-center lg:w-1/2 lg:items-end">
                ...
                <input id="username" name="username" type="text" class="w-2/3 border-2 border-b-accent rounded-md p-2 px-4 text-lg bg-gray-100 focus:outline-none focus:border-accent hover: hover:bg-primary30 focus:bg-primary30" placeholder="Username" />


                <input id="password" name="password" type="password" class="w-2/3 border-2 border-b-accent rounded-md p-2 px-4 text-lg bg-gray-100 focus:outline-none focus:border-accent hover: hover:bg-primary30 focus:bg-primary30" placeholder="Password" />
